      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
        <div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button type="submit" className="w-full" disabled={loading || !humanVerification}>
                      {loading ? (
                        ...
                        <><Mail className="mr-2 h-4 w-4" /> Create Account with Email</>
                      )}
                    </Button>
          ...
          <div className="mt-6 text-center text-sm text-muted-foreground">
            <p>
              Browse projects in preview mode or create an account to contribute.
              <br />
              <span className="font-medium">
                Creating an account allows you to vote and add projects.
              </span>
            </p>
          </div>
        </div>
